...
#    lexicon_path = data_folder+"en_frame_lexicon.json"
#    lexicon_path = data_folder+"en_frame_element_lexicon.json"
#    lexicon_path = data_folder+"nl_frame_lexicon.json"
#    lexicon_path = data_folder+"nl_frame_element_lexicon.json"
